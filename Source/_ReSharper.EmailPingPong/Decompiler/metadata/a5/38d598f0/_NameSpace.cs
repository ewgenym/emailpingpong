...
namespace Microsoft.Office.Interop.Outlook
{
  ...
  public interface _NameSpace
  {
    ...
    /// </summary>
    [DispId(61440)]
    Application Application { [DispId(61440), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    /// Returns an <see cref="T:Microsoft.Office.Interop.Outlook.OlObjectClass"/> constant indicating the object's class. Read-only.
    /// </summary>
    [DispId(61450)]
    OlObjectClass Class { [DispId(61450), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    /// Returns the <see cref="T:Microsoft.Office.Interop.Outlook.NameSpace"/>  object for the current session. Read-only.
    /// </summary>
    [DispId(61451)]
    NameSpace Session { [DispId(61451), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    /// Returns the parent Object of the specified object. Read-only.
    /// </summary>
    [DispId(61441)]
    object Parent { [DispId(61441), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(8449)]
    Recipient CurrentUser { [DispId(8449), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(8451)]
    Folders Folders { [DispId(8451), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    /// Returns a String (string in C#) indicating the type of the specified object.  Read-only.
    /// </summary>
    [DispId(8452)]
    string Type { [DispId(8452), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(8461)]
    AddressLists AddressLists { [DispId(8461), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(8472)]
    SyncObjects SyncObjects { [DispId(8472), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64076)]
    bool Offline { [DispId(64076), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    /// This object, member, or enumeration is deprecated and is not intended to be used in your code.
    /// </summary>
    [DispId(61696)]
    object MAPIOBJECT { [TypeLibFunc(64), DispId(61696), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64193)]
    OlExchangeConnectionMode ExchangeConnectionMode { [DispId(64193), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64208)]
    Accounts Accounts { [DispId(64208), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    /// Returns a String (string in C#) representing the name of the current profile. Read-only.
    /// </summary>
    [DispId(64213)]
    string CurrentProfileName { [DispId(64213), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64216)]
    Stores Stores { [DispId(64216), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64236)]
    Store DefaultStore { [DispId(64236), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64421)]
    Categories Categories { [DispId(64421), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64517)]
    string ExchangeMailboxServerName { [DispId(64517), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64516)]
    string ExchangeMailboxServerVersion { [DispId(64516), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64515)]
    string AutoDiscoverXml { [DispId(64515), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
    /// <summary>
    ...
    /// </summary>
    [DispId(64558)]
    OlAutoDiscoverConnectionMode AutoDiscoverConnectionMode { [DispId(64558), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
